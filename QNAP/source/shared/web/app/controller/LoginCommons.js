Ext.define('AlarmClock.controller.LoginCommons', {
    ...
    signInSuccess: function (host) {
        ...
        commonFuncs.animateActiveItem(mainView, { type: 'slide', direction: 'left' }, true);
    },
    ...
    checkVersion: function () {
        var me = this;
        console.log('checking NAS package version ...');
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                if (loginResponse.status === "OK") {
                    try {
                        globalVars.currentPackageVersion = loginResponse.data;
                        console.log("Current NAS package version = " + globalVars.currentPackageVersion + ". Required version = " + globals.minPackageVersion);
                    } catch (err) {
                        console.log("error parse NAS package Version = " + loginResponse.data);
                    }
                    if (globalVars.currentPackageVersion >= globals.minPackageVersion) {
                        me.signInSuccess(me.apiURL);
                        return;
                    }
                }

                console.log("NAS package version is lower than required");
                me.signInFailure('You should update your "Alarm Clock" package for QNAP NAS.<br>Minimum supported version is: <b>' + globals.minPackageVersion + '</b><br/><br/><a target="_system" href="http://www.nasalarmclock.com/downloads/' + globals.nasType + '/">Download</a>', true);
            },
