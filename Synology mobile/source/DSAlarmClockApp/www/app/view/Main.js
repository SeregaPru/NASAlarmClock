Ext.define('AlarmClock.view.Main', {
                ...
                items: [
...

                    {
                        ...
                        // duration
                        {
                            ...
                            labelWidth: (this.wideScreen ? 240 : 150),
                            //decimalPrecision: 1,
                            minValue: 0,
                            maxValue: 999,
                            value: 2,
    ...
    createDetailsPage: function () {
        ...
        Ext.Viewport.add(this.detailsPage);
    ...
    onRowClick: function (record, showDetails, source) {
        ...
        if (this.bigScreen) {
            ...
            if (showDetails) {
                ...
                Ext.Viewport.animateActiveItem(me.detailsPage, {
                    type: 'slide',
                    direction: 'left',
                    listeners: {
    ...
    showSettings: function () {
        ...
        Ext.Viewport.animateActiveItem(settingsView, { type: 'slide', direction: 'left' });
    },
    ...
    playTask: function () {
        ...
        Ext.Viewport.add(this.playPage);
        Ext.Viewport.animateActiveItem(this.playPage, { type: 'slide', direction: 'left' });
            ...
            success: function (response, options) {
                ...
                try {
                    ...
                    if (ver_data.nas == globals.nasType) {
                        var availVersion = ver_data.version;
                        console.log("Current NAS package version = " + globalVars.currentPackageVersion + ". Latest available package version = " + availVersion);

                        if (globalVars.currentPackageVersion < availVersion) {
